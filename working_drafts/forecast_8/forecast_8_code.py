...
fig.savefig('../Wk7_Obs.png', dpi=300, bbox_inches='tight')
...
fig = historical_weekly_flow(start_year, end_year, fcst_month, fcst_st,
                             fcst_end)
fig.savefig('../1Wk_Flow_History.png', dpi=300, bbox_inches='tight')
...
fig = historical_weekly_flow(start_year, end_year, fcst_month, fcst_st,
                             fcst_end)
fig.savefig('../2Wk_Flow_History.png', dpi=300, bbox_inches='tight')
...
ax.grid(None, 'major', 'both', alpha=0.15)
fig.set(facecolor='lightgrey')
fig.savefig('../Month_Histogram.png', dpi=300, bbox_inches='tight')
